...
#ifndef PATH_TRACING_RENDERER2_H
#define PATH_TRACING_RENDERER2_H
...
// Compute version.
class Renderer2: public ComputeRenderPass {
    struct MeshInfo {
        mat4 world2local;
        vec4 emission;
        int materialPtr;
...
public:
    ...
    Renderer2(const string &shaderPath);
...
#endif //PATH_TRACING_RENDERER2_H
